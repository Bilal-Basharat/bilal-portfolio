        ...
        <div className="flex flex-col-reverse items-start justify-between gap-12 md:flex-row md:items-center md:gap-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="reveal reveal-delay-3 mt-7 max-w-2xl text-base leading-relaxed text-muted md:text-lg md:text-justify">
              ...
              shipped a SaaS platform running live across 15 restaurants,
              designed APIs and third-party integrations, and handled everything
              between authentication, payments, and deployment. I value
              continuous learning, clean and maintainable work, and the
              professionalism that turns good code into dependable products.
            </p>
